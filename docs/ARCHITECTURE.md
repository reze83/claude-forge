...
| test-codex.sh    | 22    | Codex Wrapper (error handling, timeout, model flag, render_template, context-file, template, live)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
Total: 295 tests (222 hooks + 35 install + 9 plugin + 6 update + 22 codex + 1 validate).
