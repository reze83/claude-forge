...
| ---------------- | ----- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| test-hooks.sh    | 113   | bash-firewall (48: basic+bypass+subshell/pipe/backtick/herestring), protect-files (29: basic+case-insensitive+allowlist+tampering+non-ASCII), secret-scan (16: pre+post+pragma), auto-format (2), session-logger (3: basic+log-rotation), session-start (2), post-failure (2), pre-compact (2), task-gate (2), teammate-gate (2) |
...
Total: 142 tests (113 hooks + 11 install + 6 update + 11 codex + 1 validate).
