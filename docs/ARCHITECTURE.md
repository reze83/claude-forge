...
| `notify(message)`     | Desktop notification: WSL→PowerShell toast, Linux→notify-send.                                     |
...
Total: 272 tests (217 hooks + 35 install + 6 update + 13 codex + 1 validate).
