...
| test-install.sh  | 27    | Install/Uninstall Lifecycle (Hardlinks, rekursive Skills, Repo-Marker), Symlink-Migration, QA-Tools Section, Settings-Merge Edge Cases (corrupt JSON, empty settings, dry-run)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
Total: 240 tests (195 hooks + 27 install + 6 update + 11 codex + 1 validate).
