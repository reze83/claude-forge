...
| test-install.sh  | 29    | Install/Uninstall Lifecycle (Hardlinks, rekursive Skills, VERSION deploy, Repo-Marker), Symlink-Migration, QA-Tools Section, Settings-Merge Edge Cases (corrupt JSON, empty settings, dry-run)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
Total: 254 tests (207 hooks + 29 install + 6 update + 11 codex + 1 validate).
