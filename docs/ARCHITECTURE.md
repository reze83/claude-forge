...
| test-codex.sh    | 13    | Codex Wrapper (error handling, timeout validation incl. non-numeric, model flag, live)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
Total: 286 tests (222 hooks + 35 install + 9 plugin + 6 update + 13 codex + 1 validate).
